 ...
 */
package sijangkar.perhubungan.jatengprov.myapplication.library.service;
...
public class CopyAssetService extends IntentService {
    ...
    public static void startCopyAction(Context context, String asset, String destinationPath) {
        Intent intent = new Intent(context, es.voghdev.pdfviewpager.library.service.CopyAssetService.class);
