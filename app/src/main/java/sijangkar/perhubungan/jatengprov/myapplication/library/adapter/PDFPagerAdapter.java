 ...
 */
package sijangkar.perhubungan.jatengprov.myapplication.library.adapter;
...
public class PDFPagerAdapter extends BasePDFPagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        SubsamplingScaleImageView ssiv = v.findViewById(es.voghdev.pdfviewpager.library.R.id.subsamplingImageView);
    ...
    public static class Builder {
        ...
        public es.voghdev.pdfviewpager.library.adapter.PDFPagerAdapter create() {
            es.voghdev.pdfviewpager.library.adapter.PDFPagerAdapter adapter = new es.voghdev.pdfviewpager.library.adapter.PDFPagerAdapter(context, pdfPath);
