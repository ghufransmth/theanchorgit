...
public class PeringatanKeduaActivity extends Fragment implements PeringatanAdapter.peringatanListener, AlertDialogHelper.AlertDialogListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_peringatan_kedua,container,false);
        ...
        container.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), container, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                if (!isMultiSelect) {
                    ...
                    if (mActionMode == null) {
                        mActionMode = PeringatanKeduaActivity.this.getActivity().startActionMode(mActionModeCallback);
                    }
                }
    ...
    private void getPeringatan(){
        ...
        Call<responseperingatan> call = mApiService.peringatanRequest(sharedPrefManager.getAccessToken(), "2");
        call.enqueue(new Callback<responseperingatan>() {
            ...
            public void onResponse(Call<responseperingatan> call, Response<responseperingatan> response) {
                ...
                adapter = new PeringatanAdapter(peringatanList, mContext, PeringatanKeduaActivity.this);
                container.setAdapter(adapter);
