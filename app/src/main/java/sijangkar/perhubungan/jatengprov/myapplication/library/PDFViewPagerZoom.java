 ...
 */
package sijangkar.perhubungan.jatengprov.myapplication.library;
...
public class PDFViewPagerZoom extends PDFViewPager {
    ...
    protected void init(AttributeSet attrs) {
        if (isInEditMode()) {
            setBackgroundResource(es.voghdev.pdfviewpager.library.R.drawable.flaticon_pdf_dummy);
            return;
        }
        ...
        if (attrs != null) {
            ...
            a = context.obtainStyledAttributes(attrs, es.voghdev.pdfviewpager.library.R.styleable.PDFViewPager);
            String assetFileName = a.getString(es.voghdev.pdfviewpager.library.R.styleable.PDFViewPager_assetFileName);
            float scale = a.getFloat(es.voghdev.pdfviewpager.library.R.styleable.PDFViewPager_scale, PdfScale.DEFAULT_SCALE);
