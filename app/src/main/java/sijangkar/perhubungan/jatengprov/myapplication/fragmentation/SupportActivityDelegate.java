...
import sijangkar.perhubungan.jatengprov.myapplication.fragmentation.anim.DefaultVerticalAnimator;
import sijangkar.perhubungan.jatengprov.myapplication.fragmentation.anim.FragmentAnimator;
import sijangkar.perhubungan.jatengprov.myapplication.fragmentation.debug.DebugStackDelegate;
...
public class SupportActivityDelegate {
    ...
    public void destroyFragment(ISupportFragment hideFragment) {
        mTransactionDelegate.destroyFragment(getSupportFragmentManager(), hideFragment);
    }

    public void startCamera(ISupportFragment showFragment, ISupportFragment hideFragment) {
        mTransactionDelegate.startCamera(getSupportFragmentManager(), showFragment, hideFragment);
    }

    public void stopCamera(ISupportFragment showFragment, ISupportFragment hideFragment) {
        mTransactionDelegate.stopCamera(getSupportFragmentManager(), showFragment, hideFragment);
    }
